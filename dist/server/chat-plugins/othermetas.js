...
const commands = {
  ...
  mixandmegahelp: [
    `/mnm <pokemon> @ <mega stone>[, generation] - Shows the Mix and Mega evolved Pok\xE9mon's type and stats.`
  ],
  orb: "stone",
  megastone: "stone",
  stone(target) {
  ...
  stonehelp: [`/stone <mega stone>[, generation] - Shows the changes that a mega stone/orb applies to a Pok\xE9mon.`],
  350: "350cup",
