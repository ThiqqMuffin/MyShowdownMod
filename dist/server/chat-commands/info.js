...
`;
  ...
  opensource(target, room, user) {
    if (!this.runBroadcast())
      return;
    this.sendReplyBox(
      `Pok&eacute;mon Showdown is open source:<br />- Language: mostly TypeScript, a little PHP<br />- <a href="https://github.com/smogon/pokemon-showdown/commits/master">What's new?</a><br />- <a href="https://github.com/smogon/pokemon-showdown">Server source code</a><br />- <a href="https://github.com/smogon/pokemon-showdown-client">Client source code</a><br />- <a href="https://github.com/Zarel/Pokemon-Showdown-Dex">Dex source code</a>`
    );
  },
  opensourcehelp: [
