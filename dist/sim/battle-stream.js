...
`);
      switch (type2) {
        case "update":
          streams.omniscient.push(import_battle.Battle.extractUpdateForSide(data, "omniscient"));
          streams.spectator.push(import_battle.Battle.extractUpdateForSide(data, "spectator"));
          streams.p1.push(import_battle.Battle.extractUpdateForSide(data, "p1"));
          streams.p2.push(import_battle.Battle.extractUpdateForSide(data, "p2"));
          streams.p3.push(import_battle.Battle.extractUpdateForSide(data, "p3"));
          streams.p4.push(import_battle.Battle.extractUpdateForSide(data, "p4"));
          break;
        case "sideupdate":
