...
class RandomLetsGoTeams extends import_random_teams.default {
  ...
  randomTeam() {
    ...
    for (const id in this.dex.data.FormatsData) {
      ...
      if (species.num < 1 || species.num > 151 && ![808, 809].includes(species.num) || species.gen > 7 || species.nfe || !species.randomBattleMoves?.length || this.forceMonotype && !species.types.includes(this.forceMonotype)) {
        continue;
      }
      pokemonPool.push(id);
    }
