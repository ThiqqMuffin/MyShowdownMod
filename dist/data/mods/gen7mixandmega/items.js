...
const Items = {
  blueorb: {
    ...
    onPrimal(pokemon) {
      const species = this.actions.getMixedSpecies(pokemon.m.originalSpecies, "Kyogre-Primal");
  ...
  redorb: {
    ...
    onPrimal(pokemon) {
      const species = this.actions.getMixedSpecies(pokemon.m.originalSpecies, "Groudon-Primal");
